...
!function (t) {
    ...
    var i = {}, e = window.UIkit || void 0;
    if (i.version = "2.27.5", i.noConflict = function () {
        ...
        var t = function () {
            var t, i = document.body || document.documentElement, e = {
        ...
        var s = i.$win.scrollLeft(), a = i.$win.scrollTop(), r = o.offset(), l = r.left, c = r.top;
        return n = t.extend({
            topoffset: 0,
            leftoffset: 0
    ...
    if (!t.fn.swipeLeft) {
        var a, r, l, c, u, d = {}, h = 750, p = "ontouchstart" in window, f = window.PointerEvent,
    ...
    t.component("scrollspy", {
        defaults: {
            ...
            var i, e = this, o = this.options.cls.split(/,/), s = function () {
                var n = e.options.target ? e.element.find(e.options.target) : e.element, s = 1 === n.length ? 1 : 0,
                    a = 0;
                n.each(function () {
                    var n = t.$(this), r = n.data("inviewstate"), l = t.Utils.isInView(n, e.options),
    ...
    t.component("scrollspynav", {
        defaults: {cls: "uk-active", closest: !1, topoffset: 0, leftoffset: 0, smoothscroll: !1}, boot: function () {
            ...
            var e, n = [], o = this.find("a[href^='#']").each(function () {
                ...
                }), a = t.$(n.join(",")), r = this.options.cls, l = this.options.closest || this.options.closest, c = this,
                u = function () {
                    e = [];
        ...
        defaults: {
            ...
            if (this.dropdown.length) {
                ...
                var e, n = t.$.extend({}, this.offsetParent.offset(), {
                    ...
                    }), s = this.options.offset, a = this.dropdown,
                    r = (a.show().offset() || {left: 0, top: 0}, a.outerWidth()), l = a.outerHeight(),
    ...
    t.$win.on("resize orientationchange", t.Utils.debounce(function () {
        ...
        init: function () {
            if (e || (e = t.$("body")), this.element.length) {
                var i = this;
                this.paddingdir = "padding-" + ("left" == t.langdirection ? "right" : "left"), this.dialog = this.find(".uk-modal-dialog"), this.active = !1, this.element.attr("aria-hidden", this.element.hasClass("uk-open")), this.on("click", ".uk-modal-close", function (e) {
                    e.preventDefault();
                    var n = t.$(e.target).closest(".uk-modal");
                    n[0] === i.element[0] && i.hide()
                }).on("click", function (e) {
                    var n = t.$(e.target);
        ...
        updateScrollable: function () {
            ...
            if (t.length) {
                t.css("height", 0);
                var i = Math.abs(parseInt(this.dialog.css("margin-top"), 10)), e = this.dialog.outerHeight(),
                    n = window.innerHeight, o = n - 2 * (20 > i ? 20 : i) - e;
    ...
    var i = {x: window.scrollX, y: window.scrollY}, e = (t.$win, t.$doc, t.$html), n = {
        show: function (n, o) {
            if (n = t.$(n), n.length) {
                ...
                var s = t.$("body"), a = n.find(".uk-offcanvas-bar:first"), r = "right" == t.langdirection,
                    l = a.hasClass("uk-offcanvas-bar-flip") ? -1 : 1, c = l * (r ? -1 : 1),
            ...
            var o = t.$("body"), s = t.$(".uk-offcanvas.uk-active"), a = "right" == t.langdirection,
                r = s.find(".uk-offcanvas-bar:first"), l = function () {
