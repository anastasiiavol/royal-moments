...
!function (i) {
    ...
    return i.component("lightbox", {
        ...
        fitSize: function () {
            var t = this, e = this.data, o = this.modal.dialog.outerWidth() - this.modal.dialog.width(),
                n = parseInt(this.modal.dialog.css("margin-top"), 10),
                s = parseInt(this.modal.dialog.css("margin-bottom"), 10), h = n + s, a = e.meta.content,
            ...
            }), c = e.meta.width, g = e.meta.height;
        ...
        init: function (i) {
            var t = /(\/\/.*?youtube\.[a-z]+)\/watch\?v=([^&]+)&?(.*)/, n = /youtu\.be\/(.*)/;
